                ...
                {timeSlots.map((slot) => {
                    ...
                    return (
                        <button
                            ...
                            className={`h-12 rounded-lg border text-base transition-colors ${slot.full ? "cursor-not-allowed border-dashed border-[#e3dbd0] bg-[#F5EFE5] text-[#9C8E84]"
                                : isSelected ? "border-[#d6422f] bg-[#d6422f] font-semibold text-white"
                                    : "border-[#e3dbd0] bg-white text-[#2B211C] hover:bg-[#faf7f3]"}`}>
                            {slot.time}
                        </button>
                    );
                })}
