...
| `03 店家端` | 17 | S-01、S-02、S-02b～S-02d、S-03～S-07、S-07b、S-08～S-10、S-10b、S-11、S-12 |

合計主批 50 個、選配的狀態示範 8 個，共 58 個畫框。
...
- 每張畫面在 Figma 上排哪一列，由 `figma_prep.py` 的 `FLOW` 決定；新增畫面一定要加進去。
  C-20 排在「會員」列 C-15 後面，S-07b／S-10b 各自排在 S-07／S-10 後面。
...
- **抽取**：每個畫框的座標與原稿逐一比對（目前 58 個畫框；節點數每次重量都會變）
